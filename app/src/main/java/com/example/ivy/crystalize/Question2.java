...
public class Question2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String point = intent.getStringExtra(QuestionActivity.EXTRA_MESSAGE);
    ...
    public void onHintClick(View view){
        Toast toast = Toast.makeText(getApplicationContext(),getString(R.string.H2), Toast.LENGTH_SHORT);
        toast.show();
    }
    ...
    public void onAnswerClick(View view){
        ...
        String correctAnswer = getString(R.string.A2);
        Intent intent=getIntent();
        String point = intent.getStringExtra(QuestionActivity.EXTRA_MESSAGE);
        if(answer.equals(correctAnswer)){
            int sum = Integer.parseInt(point) + 1;
            Intent intent1= new Intent(this,Question3.class);
            Toast toast = Toast.makeText(getApplicationContext(),"RIGHT!"+ sum+"/4", Toast.LENGTH_SHORT);
            toast.show();
            intent1.putExtra(EXTRA_MESSAGE, Integer.toString(sum));
            startActivity(intent1);
        }else{
            Intent intent1= new Intent(this,Question3.class);
            Toast toast = Toast.makeText(getApplicationContext(),"Wrong! Answer is 【"+getString(R.string.A2) +"】"  + point +"/4", Toast.LENGTH_SHORT);
            toast.show();
