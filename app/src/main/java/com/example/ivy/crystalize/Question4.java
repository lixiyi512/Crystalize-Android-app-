...
public class Question4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String point = intent.getStringExtra(Question3.EXTRA_MESSAGE);
    ...
    public void onHintClick(View view){
        Toast toast = Toast.makeText(getApplicationContext(),getString(R.string.H4), Toast.LENGTH_SHORT);
        toast.show();
    }
    ...
    public void onAnswerClick(View view){
        ...
        String correctAnswer = getString(R.string.A4);
        Intent intent=getIntent();
        String point = intent.getStringExtra(Question3.EXTRA_MESSAGE);
        if(answer.equals(correctAnswer)){
            ...
            Intent intent1= new Intent(this,Result.class);
            Toast toast = Toast.makeText(getApplicationContext(),"Wrong! Answer is 【"+getString(R.string.A4) +"】" +  point +"/4", Toast.LENGTH_SHORT);
            toast.show();
